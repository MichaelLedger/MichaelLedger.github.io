...
var L2Dwidget = function(t) {
    ...
    var r = e(1),
        ...
        a = function(t, n, e) {
            ...
            for (s in v && (e = n), e)
                l = ((f = !d && b && void 0 !== b[s]) ? b : e)[s], p = m && f ? u(l, r) : y && "function" == typeof l ? u(Function.call, l) : l, b && c(b, s, l, t & a.U), w[s] != l && i(w, s, p), y && g[s] != l && (g[s] = l)
        };
    ...
    var r = e(3),
        ...
        a = function() {
            var t,
                n = e(19)("iframe"),
                r = i.length;
            for (n.style.display = "none", e(32).appendChild(n), n.src = "javascript:", (t = n.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), a = t.F; r--;)
    ...
    var r,
        ...
        F = function(t) {
            m.call(a, function() {
                ...
                }), t._h = T || R(t) ? 2 : 1), t._a = void 0, i && n.e)
                    throw n.v
            })
        },
        R = function(t) {
    ...
    t.exports = {
        model: {
            jsonPath: "https://michaelledger.github.io/plugins/live2d/packages/live2d-widget-model-shizuku/assets/shizuku.model.json",
