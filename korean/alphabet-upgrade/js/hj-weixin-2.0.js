 ...
 * @author: roeis
 * @description: Weixin JS-SDK, 微信公开API, 封装了一些借口，陆续更新,
 *               需要ajax支持, 依赖jQuery or Zepto
 */
!function(a, b) {
...
!function(a) {
    "use strict";
    var b = "https://con-wx.hjapi.com/v1/accesstoken/getWeiXinSignature",
        c = {
            lang: "",
        ...
        d = {
            ...
            imgUrl: "http://i3.s.7.hjfile.cn/entry/201501/871c9898-5b42-4494-9a20-934d9509f49e.png",
            success: function() {},
            cancel: function() {}
        },
        e = {
        ...
        f = {
            isWeixin: function() {
                return window.navigator.userAgent.toLowerCase().indexOf("micromessenger") > -1 ? !0 : !1
            },
            getConfig: function(a) {
                var d = $.extend({}, e, a);
                c.lang = d.lang, f._ajaxData(b, c, function(a) {
                    0 === a.status && f._configTicket(a.data, d)
                })
            },
            _configTicket: function(a, b) {
                wx.config({
                    debug: b.debug,
                    appId: a.appId,
                    timestamp: a.timeStamp,
            ...
            resetData: function(a) {
                $.extend(d, a), wx.ready(function() {
                    wx.onMenuShareAppMessage(d), wx.onMenuShareTimeline(d), wx.onMenuShareQQ(d), wx.onMenuShareWeibo(d)
                })
            },
